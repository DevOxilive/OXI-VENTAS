...
class EmployeeController extends Controller
{
    ...
    private function validateEmployee(Request $request, ?Employee $employee = null): array
    {
        ...
        return $request->validate([
            ...
            'emergencyContactName' => ['nullable', 'string', 'max:80'],
            'emergencyContactRelationship' => ['nullable', Rule::in($this->relationshipOptions())],
            'emergencyContactPhone' => ['nullable', 'digits:10'],
