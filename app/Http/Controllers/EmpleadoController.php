...
class EmpleadoController extends Controller
{
    public function index()
    {
        $empleados = Empleado::latest()->get()->map(function ($empleado) {
            return [
                ...
                'numeroExterior' => $empleado->numero_exterior,
                'numeroInterior' => $empleado->numero_interior,
                'codigoPostal' => $empleado->codigo_postal,
                'colonia' => $empleado->colonia,
                'municipio' => $empleado->municipio,
                'estadoDomicilio' => $empleado->estado_domicilio,
                'urlMaps' => $empleado->url_maps,
    ...
    public function store(Request $request)
    {
        ...
        Empleado::create([
            ...
            'calle' => $request->calle,
            'numero_exterior' => $request->numeroExterior,
            'numero_interior' => $request->numeroInterior,
            'codigo_postal' => $request->codigoPostal,
            'colonia' => $request->colonia,
            'municipio' => $request->municipio,
            'estado_domicilio' => $request->estadoDomicilio,
            'url_maps' => $request->urlMaps,
