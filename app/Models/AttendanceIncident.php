...
{
    protected $fillable = ['employee_id', 'attendance_record_id', 'type', 'incident_date', 'incident_time', 'estimated_arrival_at', 'rest_day_requested', 'rest_day_date', 'make_up_date', 'reason', 'evidence_path', 'status', 'authorized_by', 'authorized_at', 'authorization_notes'];
