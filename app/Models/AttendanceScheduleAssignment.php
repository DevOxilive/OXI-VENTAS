...
{
    protected $fillable = ['attendance_schedule_id', 'assignable_type', 'assignable_id', 'effective_from', 'effective_to', 'priority', 'shift_order', 'observations', 'working_days', 'assigned_by', 'active'];
