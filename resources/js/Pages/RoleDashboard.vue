...
const permissionLabelMap = {
    ...
    'sales.employee-credit.create': 'Dar crédito',
    'sales.employee-credit.collect': 'Registrar abonos',
    'sales.employee-credit.print': 'Reimprimir tickets de estado de cuenta',
    'reports.sales.view': 'Ver reportes de ventas',
    'reports.sales.export.excel': 'Exportar ventas en Excel',
    'reports.sales.export.pdf': 'Exportar ventas en PDF',
    ...
    'reports.audits.export.excel': 'Exportar auditorias en Excel',
    'reports.audits.export.pdf': 'Exportar auditorias en PDF',
    ...
    'reports.inventory.export.excel': 'Exportar inventario en Excel',
    'reports.inventory.export.pdf': 'Exportar inventario en PDF',
    'reports.movements.view': 'Ver reportes de movimientos',
    'reports.movements.export.excel': 'Exportar movimientos en Excel',
    'reports.movements.export.pdf': 'Exportar movimientos en PDF',
...
const permissionCatalog = [
    ...
    },
    {
        ...
        permissions: ['sales.employee-credit.view', 'sales.employee-credit.create', 'sales.employee-credit.collect', 'sales.employee-credit.print'],
    },
    {
        key: 'cashClosures',
    ...
    },
    {
        ...
        icon: 'assessment',
        permissions: ['reports.cash-closures.view', 'reports.cash-closures.create', 'reports.cash-closures.update', 'reports.cash-closures.delete'],
    },
    {
        key: 'printers',
        title: 'Impresoras',
    ...
    },
    {
        ...
        title: 'Auditorias',
        icon: 'fact_check',
        permissions: ['audits.physical-counts.count', 'audits.physical-counts.view-stock', 'audits.physical-counts.create', 'audits.physical-counts.close', 'audits.physical-counts.reopen', 'audits.physical-counts.finalize', 'audits.physical-counts.participants', 'audits.physical-counts.apply', 'audits.physical-counts.delete'],
    },
    {
        key: 'purchases',
...
const permissionAction = (permission) => {
    ...
    const actionMap = {
        ...
        'departments.view': { icon: 'visibility', href: route('human-resources.departments.index') },
        'departments.create': { icon: 'domain_add', href: route('human-resources.departments.index') },
        'departments.update': { icon: 'edit', href: route('human-resources.departments.index') },
        'departments.delete': { icon: 'delete', href: route('human-resources.departments.index') },
        'positions.view': { icon: 'visibility', href: route('human-resources.departments.index') },
        'positions.create': { icon: 'person_add', href: route('human-resources.departments.index') },
        'positions.update': { icon: 'edit', href: route('human-resources.departments.index') },
        'positions.delete': { icon: 'delete', href: route('human-resources.departments.index') },
        ...
        'reports.sales.view': { icon: 'monitoring', href: route('inventory.reports.sales') },
        'reports.sales.export.excel': { icon: 'table_view', href: route('inventory.reports.sales') },
        'reports.sales.export.pdf': { icon: 'picture_as_pdf', href: route('inventory.reports.sales') },
        ...
        'reports.cash-closures.create': { icon: 'add_card', href: route('inventory.reports.select', { report: 'cash-closures' }) },
        'reports.cash-closures.update': { icon: 'edit', href: route('inventory.reports.select', { report: 'cash-closures' }) },
        'reports.cash-closures.delete': { icon: 'delete', href: route('inventory.reports.select', { report: 'cash-closures' }) },
        ...
        'reports.audits.export.excel': { icon: 'table_view', href: route('inventory.reports.select', { report: 'audits' }) },
        'reports.audits.export.pdf': { icon: 'picture_as_pdf', href: route('inventory.reports.select', { report: 'audits' }) },
        ...
        'audits.physical-counts.reopen': { icon: 'lock_open', href: branchHref((branch) => route('audits.physical-counts.index', { branch: branch.slug })) },
        'audits.physical-counts.finalize': { icon: 'verified', href: branchHref((branch) => route('audits.physical-counts.index', { branch: branch.slug })) },
        ...
        'reports.inventory.export.excel': { icon: 'table_view', href: route('inventory.reports.select', { report: 'inventory' }) },
        'reports.inventory.export.pdf': { icon: 'picture_as_pdf', href: route('inventory.reports.select', { report: 'inventory' }) },
        'reports.movements.view': { icon: 'sync_alt', href: route('inventory.reports.select', { report: 'movements' }) },
        'reports.movements.export.excel': { icon: 'table_view', href: route('inventory.reports.select', { report: 'movements' }) },
        'reports.movements.export.pdf': { icon: 'picture_as_pdf', href: route('inventory.reports.select', { report: 'movements' }) },
        'sales.employee-credit.view': { icon: 'account_balance_wallet', href: route('ventas.employee-credit.index') },
        'sales.employee-credit.create': { icon: 'credit_score', href: route('ventas.home') },
        'sales.employee-credit.collect': { icon: 'payments', href: route('ventas.employee-credit.index') },
        'sales.employee-credit.print': { icon: 'print', href: route('ventas.employee-credit.index') },
...
const allQuickActions = computed(() => [
    ...
    },
    {
        id: 'departments',
        label: 'Departamentos',
        description: 'Departamentos y puestos.',
        icon: 'account_tree',
        routeName: 'human-resources.departments.index',
        visible: canAny([
            'departments.view', 'departments.create', 'departments.update', 'departments.delete',
            'positions.view', 'positions.create', 'positions.update', 'positions.delete',
        ]),
