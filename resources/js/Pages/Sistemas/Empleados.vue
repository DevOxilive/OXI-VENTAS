    ...
    <div class="bg-[#f6f3f7] min-h-screen rounded-3xl p-6">
        ...
        <div class="flex items-center justify-between mb-5 gap-4 flex-wrap">
            ...
            <div class="flex gap-3">
                <button v-if="can('usuarios.crear')" @click="vista = 'empleados'"
                    class="px-5 py-2 rounded-xl border shadow-sm"
                    :class="vista === 'empleados' ? 'bg-black text-white' : 'bg-white'">
                    Empleados
                </button>

                <button v-if="can('usuarios.ver')" @click="vista = 'usuarios'"
                    class="px-5 py-2 rounded-xl border shadow-sm"
                ...
                <tbody>
                    <tr v-for="emp in listaActual" :key="emp.id" @click="abrirDetalleUsuario(emp)"
                        ...
                        <td class="px-4 py-3 flex gap-2">
                            ...
                            <button v-if="vista === 'empleados' && can('usuarios.crear')" @click="abrirModal(emp)">
                                ➕ Crear usuario
                            </button>

                            <button v-if="vista === 'usuarios' && can('usuarios.editar')" @click.stop="abrirModal(emp)">
                                ✏️
                            </button>

                            <button v-if="vista === 'usuarios' && can('usuarios.eliminar')"
                ...
                <div class="grid gap-4 bg-white p-4 rounded-lg">
                    ...
                    <div>
                        <input type="password" v-model="form.password" maxlength="15" minlength="7"
                            placeholder="Contraseña" class="border rounded px-3 py-2 w-full">
                    ...
                    <div class="flex justify-between mt-3">
                        <button v-if="editando ? can('usuarios.editar') : can('usuarios.crear')"
                            @click="guardarEmpleado" class="bg-[#1f1d2b] text-white px-6 py-2 rounded-full">
                            Guardar
                        </button>
