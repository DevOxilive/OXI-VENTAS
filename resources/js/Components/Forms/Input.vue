...
<template>
    <div class="mb-4">
        ...
        <div v-if="type === 'file'" class="flex">
            <label
                class="relative inline-block w-full cursor-pointer rounded-full bg-slate-200 px-4 py-1 text-center font-semibold text-violet-800 hover:bg-violet-100 hover:text-violet-700"
            >
        ...
        <div v-else class="flex">
            <input
                ...
                class="w-full rounded-md border border-gray-400 px-3 py-2 text-gray-700 shadow shadow-sm focus:border-cyan-500 focus:border-2 focus:outline-none focus:ring-cyan-500"
                :class="className"
            />
            <input
                v-else
