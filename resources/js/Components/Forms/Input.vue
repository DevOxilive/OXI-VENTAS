...
<template>
    <div class="mb-4">
        ...
        <div v-if="type === 'file'" class="flex">
            <label
                class="relative inline-block w-full cursor-pointer rounded-full border border-secondary bg-secondary px-4 py-1 text-center font-semibold text-text transition hover:brightness-95"
            >
