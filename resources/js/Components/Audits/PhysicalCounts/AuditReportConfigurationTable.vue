...
const actions = [
    { id: 'excel', label: 'Excel', icon: 'table_view', variant: 'amber', permission: 'reports.audits.export.excel' },
    { id: 'pdf', label: 'PDF', icon: 'picture_as_pdf', variant: 'red', permission: 'reports.audits.export.pdf' },
