...
<template>
    <div class="fixed inset-0 z-[60] bg-black/60 flex items-end md:items-center justify-center" role="dialog"
        ...
        <div class="relative bg-white w-full h-[100dvh] md:h-auto md:max-h-[92vh] md:w-[96%] md:max-w-7xl rounded-t-[28px] md:rounded-3xl shadow-2xl flex flex-col overflow-hidden"
            @click.stop>
            <GeneralModalHeader title="Ajustar lote" subtitle="Corrige la información registrada del lote."
                :total-errors="totalErrors" mode="edit" @close="closeModal" />

            <GeneralModalContent :columns="1">
                <section class="w-full max-w-7xl mx-auto rounded-3xl border border-slate-200 bg-white overflow-hidden">
                        ...
                        <div class="grid grid-cols-1 xl:grid-cols-3 gap-5">
                            <section class="space-y-4">
                                <div class="rounded-3xl border border-slate-200 bg-slate-50 p-4">
                                    ...
                                    <div class="mt-4 space-y-4">
                                        ...
                                        <InputField v-model="form.supplier" label="Proveedor" placeholder="Opcional"
                                            field="supplier" :readonly="processing" :error="frontendErrors.supplier"
                                            @validate="validateField" />

                                        <InputField v-model="form.received_at" label="Fecha de ingreso"
                                            field="received_at" type="date" :readonly="processing"
                                            :error="frontendErrors.received_at" @validate="validateField" />

                                        <InputField v-model="form.expiration_date" label="Fecha de caducidad"
                                            field="expiration_date" type="date" :readonly="processing"
                                            :error="frontendErrors.expiration_date" @validate="validateField" />
                                        ...
                                        <div class="rounded-2xl border border-slate-200 bg-white p-4">
                                            ...
                                            <textarea v-model="form.notes" :readonly="processing" rows="4"
                                                maxlength="500"
                                    ...
                                    <div class="mt-4 space-y-4">
                                        ...
                                        <div v-if="isSeasonal"
                                            ...
                                            <InputField v-model="form.season_end_date" label="Fin de temporada"
                                                field="season_end_date" type="date" :readonly="processing"
                                                :error="frontendErrors.season_end_date" @validate="validateField" />
                                        </div>
                            ...
                            <section class="space-y-4">
                                <div class="rounded-3xl border border-slate-200 bg-slate-50 p-4">
                                    ...
                                    <p class="text-xs text-slate-500 mt-1">
                                        Selecciona si vas a agregar o eliminar unidades. La cantidad siempre se captura
                                        en positivo.
                                    </p>
                                    ...
                                    <div class="mt-4 space-y-4">
                                        ...
                                        <InputField v-model="form.adjustment_amount" label="Cantidad"
                                            placeholder="Ej. 2" field="adjustment_amount" type="number"
                                            :readonly="processing" :error="frontendErrors.adjustment_amount"
                                        ...
                                        <div class="rounded-2xl border border-slate-200 bg-white px-4 py-3">
                                            <p class="text-sm font-semibold" :class="form.adjustment_type === 'REMOVE' && Number(form.adjustment_amount || 0) > 0
                                                ? 'text-red-600'
