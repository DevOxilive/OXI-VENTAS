                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <div class="flex items-start justify-between gap-3">
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs font-semibold text-slate-500">
                                            {{ reasonLabel(movement.reason, movement) }}
                                        </p>
                                    </div>
                                ...
                                <div
                                    v-if="hasNotes(movement)"
                                    class="mt-3 rounded-lg bg-slate-50 px-3 py-2"
                                >
                                    <p class="text-xs font-semibold uppercase tracking-wide text-slate-400">
                                        Notas
                                    </p>
                                ...
                                <div
                                    v-if="movementBatches(movement).length"
                                ...
                                >
                                    ...
                                    <div class="space-y-1.5">
                                        <div
                                            v-for="movementBatch in movementBatches(movement)"
