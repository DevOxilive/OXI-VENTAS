    ...
    <aside class="bg-white rounded-2xl shadow-sm p-5 h-fit">
        ...
        <div>
            ...
            <div class="space-y-2 mt-3">
                <button
                    @click="$emit('update:branchFilter', 'Todas')"
                    class="w-full text-left px-4 py-2 rounded-xl text-sm border transition"
                    :class="branchFilter === 'Todas'
                ...
                <button
                    ...
                    :key="branch.id"
                    @click="$emit('update:branchFilter', branch.name)"
                    class="w-full text-left px-4 py-2 rounded-xl text-sm border transition"
                    :class="branchFilter === branch.name
                        ? 'bg-blue-600 text-white border-blue-600'
                        : 'bg-white text-blue-600 border-blue-300 hover:bg-blue-50'"
                >
                    🏪 {{ branch.name }}
        ...
        <div>
            ...
            <div class="space-y-2 mt-3">
                <button
                    @click="$emit('update:categoryFilter', 'Todas')"
                    class="w-full text-left px-4 py-2 rounded-xl text-sm border transition"
                    :class="categoryFilter === 'Todas'
                        ? 'bg-blue-600 text-white border-blue-600'
                        : 'bg-white text-blue-600 border-blue-300 hover:bg-blue-50'"
                >
