...
export function useEmpleadoForm(props, emit) {
    ...
    function cargarDatosEdicion() {
        ...
        empleado.defaults({
            ...
            calle: props.empleadoEditar.calle || "",
            numeroExterior: props.empleadoEditar.numeroExterior || "",
            numeroInterior: props.empleadoEditar.numeroInterior || "",
            codigoPostal: props.empleadoEditar.codigoPostal || "",
            colonia: props.empleadoEditar.colonia || "",
            municipio: props.empleadoEditar.municipio || "",
            estadoDomicilio: props.empleadoEditar.estadoDomicilio || "",
            urlMaps: props.empleadoEditar.urlMaps || "",
    ...
    function guardar() {
        ...
        esCreacion
            ...
            : empleado.put(
                  route("rh.empleados.update", props.empleadoEditar.id),
                  config,
              );
    }
