...
<head>
    <meta charset="UTF-8">
    @php($isMovements = ($reportType ?? 'inventory') === 'movements')
    <title>{{ $isMovements ? 'Reporte de movimientos' : 'Reporte de inventario' }}</title>
    <style>
